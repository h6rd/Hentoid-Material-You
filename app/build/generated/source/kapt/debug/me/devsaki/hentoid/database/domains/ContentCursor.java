...
public final class ContentCursor extends Cursor<Content> {
    ...
    private final static int __ID_storageFolder = Content_.storageFolder.id;
    ...
    private final static int __ID_isBeingDeleted = Content_.isBeingDeleted.id;
    ...
    public long put(Content entity) {
        ...
        String storageFolder = entity.getStorageFolder();
        int __id12 = storageFolder != null ? __ID_storageFolder : 0;
        String storageUri = entity.getStorageUri();
        int __id13 = storageUri != null ? __ID_storageUri : 0;
        Map bookPreferences = entity.getBookPreferences();
        int __id21 = bookPreferences != null ? __ID_bookPreferences : 0;

        collect400000(cursor, 0, 0,
                __id5, coverImageUrl, __id12, storageFolder,
                __id13, storageUri, __id21, __id21 != 0 ? bookPreferencesConverter.convertToDatabaseValue(bookPreferences) : null);
        ...
        collect313311(cursor, 0, 0,
                ...
                __ID_manuallyMerged, entity.isManuallyMerged() ? 1 : 0, __ID_isBeingDeleted, entity.isBeingDeleted() ? 1 : 0,
                0, 0, 0, 0);
