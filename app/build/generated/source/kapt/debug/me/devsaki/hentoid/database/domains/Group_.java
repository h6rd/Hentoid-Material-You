...
public final class Group_ implements EntityInfo<Group> {
    ...
    public final static io.objectbox.Property<Group> subtype =
        new io.objectbox.Property<>(__INSTANCE, 3, 12, int.class, "subtype");
    ...
    public final static io.objectbox.Property<Group> hasCustomBookOrder =
        new io.objectbox.Property<>(__INSTANCE, 5, 8, boolean.class, "hasCustomBookOrder");

    public final static io.objectbox.Property<Group> propertyMin =
        new io.objectbox.Property<>(__INSTANCE, 6, 10, int.class, "propertyMin");

    public final static io.objectbox.Property<Group> propertyMax =
        new io.objectbox.Property<>(__INSTANCE, 7, 11, int.class, "propertyMax");

    public final static io.objectbox.Property<Group> favourite =
        new io.objectbox.Property<>(__INSTANCE, 8, 13, boolean.class, "favourite");

    public final static io.objectbox.Property<Group> rating =
        new io.objectbox.Property<>(__INSTANCE, 9, 15, int.class, "rating");

    public final static io.objectbox.Property<Group> isBeingDeleted =
        new io.objectbox.Property<>(__INSTANCE, 10, 6, boolean.class, "isBeingDeleted");

    public final static io.objectbox.Property<Group> isFlaggedForDeletion =
        new io.objectbox.Property<>(__INSTANCE, 11, 9, boolean.class, "isFlaggedForDeletion");

    public final static io.objectbox.Property<Group> coverContentId =
        new io.objectbox.Property<>(__INSTANCE, 12, 14, long.class, "coverContentId", true);
