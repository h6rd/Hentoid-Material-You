...
public final class GroupCursor extends Cursor<Group> {
    ...
    private final static int __ID_isBeingDeleted = Group_.isBeingDeleted.id;
    ...
    public long put(Group entity) {
        ...
        long __assignedId = collect313311(cursor, entity.id, PUT_FLAG_COMPLETE,
                ...
                __ID_favourite, entity.isFavourite() ? 1 : 0, __ID_isBeingDeleted, entity.isBeingDeleted() ? 1 : 0,
