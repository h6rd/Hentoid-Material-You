...
public final class ItemDuplicateDetailBinding implements ViewBinding {
  ...
  @NonNull
  public final SwitchMaterial keepDelete;
  ...
  private ItemDuplicateDetailBinding(@NonNull FrameLayout rootView, @NonNull TextView artistScore,
      ...
      @NonNull ImageView ivSite, @NonNull TextView keepBtn, @NonNull SwitchMaterial keepDelete,
  ...
  public static ItemDuplicateDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.keep_delete;
      SwitchMaterial keepDelete = ViewBindings.findChildViewById(rootView, id);
      if (keepDelete == null) {
        break missingId;
      }
