...
public final class ActivityQueueBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView downloadReviveCancel;
  ...
  private ActivityQueueBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView downloadReviveCancel, @NonNull ProgressBar downloadReviveProgress,
  ...
  public static ActivityQueueBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView downloadReviveCancel = ViewBindings.findChildViewById(rootView, id);
