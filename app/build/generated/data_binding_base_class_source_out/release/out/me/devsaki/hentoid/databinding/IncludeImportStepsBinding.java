...
public final class IncludeImportStepsBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView importStep1Button;
  ...
  private IncludeImportStepsBinding(@NonNull View rootView, @NonNull ConstraintLayout importStep1,
      @NonNull TextView importStep1Button, @NonNull ImageView importStep1Check,
      ...
      @NonNull TextView importStep3Text, @NonNull ConstraintLayout importStep4,
      @NonNull ProgressBar importStep4Bar, @NonNull ImageView importStep4Check,
      @NonNull TextView importStep4Number, @NonNull TextView importStep4Text) {
  ...
  public static IncludeImportStepsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView importStep1Button = ViewBindings.findChildViewById(rootView, id);
      ...
      return new IncludeImportStepsBinding(rootView, importStep1, importStep1Button,
          ...
          importStep3Bar, importStep3Check, importStep3Number, importStep3Text, importStep4,
          importStep4Bar, importStep4Check, importStep4Number, importStep4Text);
    }
