...
public final class DialogLibraryChangeGroupBinding implements ViewBinding {
  ...
  @NonNull
  public final PowerSpinnerView changeGroupExistingList;
  ...
  private DialogLibraryChangeGroupBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton actionButton, @NonNull PowerSpinnerView changeGroupExistingList,
  ...
  public static DialogLibraryChangeGroupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      PowerSpinnerView changeGroupExistingList = ViewBindings.findChildViewById(rootView, id);
