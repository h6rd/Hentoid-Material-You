...
public final class ActivityAboutBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView redditText;
  ...
  private ActivityAboutBinding(@NonNull ConstraintLayout rootView, @NonNull TextView aboutText1,
      ...
      @NonNull ImageView redditIcon, @NonNull TextView redditText, @NonNull Toolbar toolbar,
      @NonNull TextView tvChromeVersionName, @NonNull TextView tvVersionName) {
  ...
  public static ActivityAboutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.redditIcon;
      ImageView redditIcon = ViewBindings.findChildViewById(rootView, id);
      if (redditIcon == null) {
        break missingId;
      }

      id = R.id.redditText;
      TextView redditText = ViewBindings.findChildViewById(rootView, id);
      if (redditText == null) {
        break missingId;
      }
      ...
      return new ActivityAboutBinding((ConstraintLayout) rootView, aboutText1, appLogo,
          ...
          personalDataStatement1, personalDataStatement2, personalDataStatement3, redditIcon,
          redditText, toolbar, tvChromeVersionName, tvVersionName);
    }
